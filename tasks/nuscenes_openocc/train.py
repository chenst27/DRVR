...
from models.drvr_nus import DRVR
from dataloader.dataset_nus_openocc import NuscenesOpenOccupancy, collate_fn_default
...
class Trainer():
    ...
    def _initDataloader(self):
        train_dataset = NuscenesOpenOccupancy(
            config=self.config, 
            pkl_file=self.config['dataset_params']['train_data_loader']['pkl_file'], 
            flip_aug=self.config['dataset_params']['train_data_loader']['flip_aug']
            )
        valid_dataset = NuscenesOpenOccupancy(
            config=self.config, 
            pkl_file=self.config['dataset_params']['val_data_loader']['pkl_file'], 
            flip_aug=self.config['dataset_params']['val_data_loader']['flip_aug']
            )
    ...
    def train(self, epoch):
        ...
        for i, data_dict in enumerate(self.train_loader):
            ...
            voxel_label_1_4 = data_dict['voxel_label_1_4'].cuda()
            batch_size = data_dict['batch_size']

            prediction = self.model(data_dict)

            ssc_logits_1_1 = prediction["ssc_logits_1_1"]
            ssc_logits_1_2 = prediction["ssc_logits_1_2"]
            sc_logits_1_4 = prediction["sc_logits_1_4"]
            num_nonempty_1_1 = prediction['num_nonempty_1_1']
            num_nonempty_1_2 = prediction['num_nonempty_1_2']
            num_nonempty_1_4 = prediction['num_nonempty_1_4']
            pred_mask_1_1 = prediction['pred_mask_1_1']
            pred_mask_1_2 = prediction['pred_mask_1_2']

            # 1:4 geo
            voxel_label_1_4_loss = voxel_label_1_4.clone().view(-1, 1)
            label_mask_1_4 = (voxel_label_1_4_loss == 0) | (voxel_label_1_4_loss == 255)
            voxel_label_1_4_loss[~label_mask_1_4] = 1
            label_mask_1_4 = (voxel_label_1_4_loss != 255).reshape(-1)
            voxel_label_1_4_loss = voxel_label_1_4_loss[label_mask_1_4]

            sc_logits_1_4 = sc_logits_1_4.permute(0,2,3,4,1).view(-1, 2)

            loss_geo_focal_1_4, loss_geo_dice_1_4 = self._computeClassifyLoss_sc(
                sc_logits_1_4[label_mask_1_4], voxel_label_1_4_loss)

            # 1:2 geo
            voxel_label_1_2_loss = voxel_label_1_2.clone().view(-1, 1)
            voxel_label_1_2_loss[~pred_mask_1_2] = 255
            ...
            empty_idx = 0
            ssc_logits_1_2 = ssc_logits_1_2.permute(0,2,3,4,1).view(-1, self.num_classes)
            sc_logits_1_2 = torch.cat([
                ssc_logits_1_2[..., empty_idx:empty_idx+1], 
                ssc_logits_1_2[..., empty_idx+1:].max(dim=-1, keepdim=True)[0]], 
                dim=-1)
            ...
            loss_sem_focal_1_2, loss_sem_dice_1_2 = self._computeClassifyLoss_ssc(
                ssc_logits_1_2[label_mask_1_2], voxel_label_1_2_loss)

            # loss
            total_loss = 0
            total_loss += loss_geo_focal_1_4
            total_loss += loss_geo_dice_1_4
            total_loss += loss_geo_focal_1_2
            total_loss += loss_geo_dice_1_2
            total_loss += loss_sem_focal_1_2
            total_loss += loss_sem_dice_1_2
            ...
            if self.recorder is not None:
                ...
                log_str += "[LR:{:0.5f}] [Loss:{:0.4f}] [num_nonempty_1_1:{}] [num_nonempty_1_2:{}] [num_nonempty_1_4:{}] [RT:{}]".format(
                            lr, loss.item(), num_nonempty_1_1, num_nonempty_1_2, num_nonempty_1_4, estimated_time) 
                ...
                # log_str += "[sc_iou_1_1:{:0.4f}] [sc_acc_1_1:{:0.4f}] [sc_recall_1_1:{:0.4f}] [num_nonempty_1_1:{}] [num_nonempty_1_2:{}] [num_nonempty_1_4:{}] [RT:{}]".format(
                #             sc_iou[1].item(), sc_acc[1].item(), sc_recall[1].item(), num_nonempty_1_1, num_nonempty_1_2, num_nonempty_1_4, estimated_time)
        ...
        with torch.no_grad():
            for i, data_dict in enumerate(self.val_loader):
                ...
                if self.recorder is not None:
                    ...
                    log_str += "[sc_iou_1_1:{:0.4f}] [sc_acc_1_1:{:0.4f}] [sc_recall_1_1:{:0.4f}] [num_nonempty_1_1:{}] [num_nonempty_1_2:{}], [num_nonempty_1_4:{}]".format(
                                sc_iou[1].item(), sc_acc[1].item(), sc_recall[1].item(), num_nonempty_1_1, num_nonempty_1_2, num_nonempty_1_4)
                    self.recorder.logger.info(log_str)
